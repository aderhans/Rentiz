        ...
        <div class="card" style="margin-bottom:1.25rem;">
            ...
            <div class="card-body">
                <div class="upload-area" onclick="document.getElementById('image-upload').click()">
                    ...
                    <div class="upload-text">Klik untuk pilih foto utama</div>
                    <div class="upload-sub">PNG, JPG, WEBP — Maks 2MB</div>
                    <input type="file" id="image-upload" name="image" accept="image/*" style="display:none;" required onchange="previewImage(event)">
                </div>
...
<script>
    ...
    function previewImage(event) {
        ...
        reader.onload = function() {
            ...
            thumb.innerHTML = '<img src="' + reader.result + '" style="width:100%;height:100%;object-fit:cover;border-radius:8px;"><div class="img-remove" onclick="this.parentElement.remove();document.getElementById(\'image-upload\').value=\'\'">✕</div>';
            document.getElementById('img-preview').innerHTML = ''; // clear old
            document.getElementById('img-preview').appendChild(thumb);
        };
